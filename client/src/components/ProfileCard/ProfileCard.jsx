...
const ProfileCard = ({ name, title, imageSrc, link }) => {
  return (
    <div className="flex flex-col items-center m-4 sm:m-10 pb-6 sm:pb-10">
      ...
      <div className="mt-4">
        <Link to={link} className="inline-block px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition-colors duration-200 ease-in-out">
          View Profile
        </Link>
      </div>
    </div>
...
ProfileCard.defaultProps = {
  ...
  link: '/profileabout' // Default link
};
